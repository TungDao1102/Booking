...
namespace Booking.Infrastructure.Migrations
{
    ...
    [Migration("20250311163455_add_review_table")]
    partial class add_review_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booking.Domain.Users.Authorizations.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Booking.Domain.Users.Authorizations.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Booking.Domain.Users.Authorizations.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Booking.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Booking.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Booking.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("Booking.Domain.Commons.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Booking.Domain.Commons.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Booking.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Booking.Domain.Commons.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Booking.Domain.Commons.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Booking.Domain.Commons.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Booking.Domain.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Booking.Domain.Users.Authorizations.RolePermission", b =>
                {
                    b.HasOne("Booking.Domain.Users.Authorizations.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("Booking.Domain.Users.Authorizations.Role", null)
                        .WithMany()
